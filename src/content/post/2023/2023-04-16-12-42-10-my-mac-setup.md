...
update: 2024-06-13 22:07:15
type: "post"
category: "reference"
---

This is a tailored setup reference for **macOS Sonoma 14** that reflects my current preferences. I will update it as macOS evolves and my requirements change.
...
Homebrew doesn't initialize the `JAVA_HOME` variable after installing a JDK. Tools, such as Maven, won't detect your JDK of choice until you set `JAVA_HOME`.
