    ...
    <div class="bg-background-quaternary">
      <div class="container-inner mx-auto textl-xl">
        <div class="w-full py-8 md:py-12">
          ...
          <h1 class="text-3xl md:text-5xl leading-tight">{{ $page.post.title }}</h1>
          ...
          <div class="flex mb-8 text-sm">
            <g-link
              ...
              :key="tag.id"
              class="bg-background-tertiary text-copy-tertiary hover:text-copy-tertiary rounded-full px-2 py-1 mr-2 text-xs hover:bg-background-quinary">
              #{{ tag.title }}
            </g-link>
          </div>
        </div>
