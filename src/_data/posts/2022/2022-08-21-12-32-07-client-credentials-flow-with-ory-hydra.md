---
id: 84dc6903-10c7-4eaf-afbb-c0ce0b1937a4
title: 'Client Credentials flow with Ory Hydra'
description: "Ory Hydra is an open source OpenID Connect Provider. It implements OAuth 2.0 Authorization Framework and the OpenID Connect Core 1.0 framework. It can issue OAuth 2.0 Access, Refresh, and ID tokens. Learn how to setup Hydra using Docker, create a client and test a Client Credentials flow."
canonical: /post/2022/08/21/client-credentials-flow-with-ory-hydra/
