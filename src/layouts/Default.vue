    ...
    <header class="bg-background-header">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-4 md:py-16">
        ...
        <div class="block lg:hidden">
          <button @click="toggle" class="flex items-center px-3 py-2 hover:text-gray-600" title="Menu">
      ...
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          <div>Copyright &copy; {{ year }} &middot; Source licensed
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://github.com/Microflash/mflash.dev/issues/new">Report an issue</a>
          </div>
        </div>
