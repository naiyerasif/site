---
slug: "post/2018/12/13/messaging-with-rabbitmq-and-spring-boot"
...
![This diagram shows a producer that sends messages to a RabbitMQ broker, which routes them through different exchange types. Direct exchanges deliver messages to specific queues, topic exchanges route messages based on routing keys, and fanout exchanges broadcast messages to multiple queues. A consumer subscribes to these queues and consumes the published messages.](./images/2018-12-13--messaging-with-rabbitmq-and-spring-boot-01.svg)
