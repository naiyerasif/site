---
slug: "post/2018/08/05/communicating-with-containers-on-docker-network"
...
::caption[Greeter UI displaying the default greeting message]
:::
...
::caption[Greeter UI displaying the custom greeting message]
:::
