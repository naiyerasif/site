---
slug: "post/2020/11/15/protecting-endpoints-with-spring-security-resource-server"
...
![A sequence depicting Local token validation flow](./images/2020-11-15--protecting-endpoints-with-spring-security-resource-server-06.png)
...
:::figure{.popout.popout-image}
![A sequence depicting token introspection flow](./images/2020-11-15--protecting-endpoints-with-spring-security-resource-server-07.png)
...
:::figure{.popout.popout-image}
![A sequence depicting hybrid token validation flow](./images/2020-11-15--protecting-endpoints-with-spring-security-resource-server-08.png)
